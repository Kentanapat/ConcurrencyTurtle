...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        new Thread(new Bob(0,0,"red",200)).start();
        new Thread(new Bob(150, 150, "blue",200)).start();
        new Thread(new Bob(-150, 150, "green",200)).start();
        new Thread(new Bob(150,-150,"black",200)).start();
        new Thread(new Bob(-150, -150, "yellow",200)).start();
...
//        System.out.println(Arrays.toString(fontNames));
    ...
    private static void initColors()
    {
        ...
        colors.put("orange", new Color(0xffa200));
        colors.put("orangered", new Color(0xff4200));
